...
tellraw @s [{"translate":"sitanywhere.uninstall.message1","fallback":"Sit Anywhere has been uninstalled.\n\nPlease remove the datapack from your world to complete the uninstallation.\n\nIf you reload the world with the datapack enabled, it will recreate the scoreboards.","color":"red"}]
tellraw @s " "
tellraw @s [{"translate":"sitanywhere.uninstall.message2","fallback":"To disable the datapack, use the command","color":"red"}," ",{"text":"§e[/datapack disable ...]","clickEvent":{"action":"suggest_command","value":"/datapack disable "}}]